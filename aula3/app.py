...
from flask_sqlalchemy import SQLAlchemy #Para criar modelos de banco de dados
...
#Rota para visualizar a receita
...
def get_recipes():
    ...
    parameters:
      ...
      - in: query
        ...
        type: integer
        required: false
        description: Tempo máximo de preparo (minutes)
    responses:
      200:
